...
class ClienteView:
    ...
    def show_menu(self, category="ENTRADAS"):
        ...
        # Crear botones en una cuadrícula de 3x3
        ...
        tk.Button(nav_frame, text="<< Anterior", command=lambda: self.navigate_categories(category, -1), font=("Arial", 14), height=2).pack(
            side=tk.LEFT, padx=10)  # Ajustar altura
        tk.Button(nav_frame, text="Ver Pedido", command=self.show_cart, font=("Arial", 14), height=2).pack(side=tk.LEFT, padx=10)  # Ajustar altura
